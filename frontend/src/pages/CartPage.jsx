        ...
        <div className='min-h-screen bg-[#fff9f6] flex justify-center p-6'>
            <div className='w-full max-w-[800px]'>
                <div className='flex items-center gap-[20px] mb-6 '>
                    ...
                    {/* FIX (stray leading quote): className was '"text-2xl font-bold  text-start'
                        — a literal " character created a bogus, non-existent class with no
                        visual effect, but it's sloppy and the quote could confuse future edits. */}

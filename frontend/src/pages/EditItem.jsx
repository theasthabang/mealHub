            ...
            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
                ...
                <form className='space-y-5' onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        {/* FIX (inconsistent default state / stale-looking dropdown): foodType
                            defaults to "" (unlike AddItem.jsx, which defaults to "veg") while
                            currentItem loads asynchronously. Previously there was no blank
                            option, so the browser fell back to showing the first <option>
                            ("veg") even though the actual state was still "" — an unmodified
                            save could then silently submit foodType: "". Adding an explicit
                            blank option keeps what's displayed honest about what's selected. */}
                        <select className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
